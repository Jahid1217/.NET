...
namespace Microsoft.AspNetCore.Identity.EntityFrameworkCore
{
    ...
    public class IdentityUserContext<TUser, TKey> : IdentityUserContext<TUser, TKey, IdentityUserClaim<TKey>, IdentityUserLogin<TKey>, IdentityUserToken<TKey>, IdentityClaim<TKey>>
	...
	/// <typeparam name="TIdentityClaim">The type of the claim object.</typeparam>
    public abstract class IdentityUserContext<TUser, TKey, TUserClaim, TUserLogin, TUserToken,TIdentityClaim> : DbContext
        where TUser : IdentityUser<TKey>
        where TKey : IEquatable<TKey>
		...
		where TIdentityClaim:IdentityClaim<TKey>
    {
        ...
        /// </summary>
        public DbSet<TIdentityClaim> Claims { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<TUserToken>(b => 
            {
			  ...
			  builder.Entity<TIdentityClaim>(b =>
            {
				b.HasKey(r => r.Id);
